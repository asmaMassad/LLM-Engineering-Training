...
# --- Load .env file ---
load_dotenv()  # loads GEMINI_API_KEY and TAVILY_API_KEY
...
def summarize_web_results(inputs):
    ...
    # Always return a dict with everything needed for the next step
    return {
        "question": question,
...
async def chat_loop():
    while True:
        ...
        # --- Tavily Web Search ---
        web_results = tavily_client.search(query=question, limit=3)  # list of strings
